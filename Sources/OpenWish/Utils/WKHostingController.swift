...
final class WKHostingController<Content>: UIHostingController<Content> where Content: View {
    ...
    private func applyTheme() {
        let backgroundColorLight = OpenWish.theme.tertiaryColor?.light ?? PrivateTheme.systemBackgroundColor.light
        let backgroundColorDark = OpenWish.theme.tertiaryColor?.dark ?? PrivateTheme.systemBackgroundColor.dark
    ...
    override func traitCollectionDidChange(_ previousTraitCollection: UITraitCollection?) {
        ...
        if traitCollection.userInterfaceStyle == previousTraitCollection.userInterfaceStyle {
            if let bgColor = OpenWish.theme.tertiaryColor {
