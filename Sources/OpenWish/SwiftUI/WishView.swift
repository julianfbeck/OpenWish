...
struct WishView: View {
    ...
    private var descriptionLineLimit: Int? {
        ...
        return OpenWish.config.expandDescriptionInList ? nil : 1
    }
    ...
    var body: some View {
        HStack(spacing: 0) {
            ...
            .alert(isPresented: $alertModel.showAlert) {
                var title = Text(OpenWish.config.localization.youCanNotVoteForYourOwnWish)
                switch alertModel.alertReason {
                case .alreadyVoted:
                    title = Text(OpenWish.config.localization.youCanOnlyVoteOnce)
                case .alreadyImplemented:
                    title = Text(OpenWish.config.localization.youCanNotVoteForAnImplementedWish)
                case .voteReturnedError(let error):
                    title = Text("Something went wrong during your vote. Try again later.\n\n\(error)")
                case .none:
                    title = Text(OpenWish.config.localization.youCanNotVoteForYourOwnWish)
                default:
                    title = Text("Something went wrong during your vote. Try again later.")
                }
            ...
            VStack(spacing: 5) {
                HStack {
                    ...
                    if viewKind == .list && OpenWish.config.statusBadge == .show {
    ...
    func badgeColor(for wishState: WishState) -> Color {
        ...
        case .approved:
            switch colorScheme {
            case .light:
                return OpenWish.theme.badgeColor.approved.light
            case .dark:
                return OpenWish.theme.badgeColor.approved.dark
            @unknown default:
                return OpenWish.theme.badgeColor.approved.light
            }
        case .implemented:
            switch colorScheme {
            case .light:
                return OpenWish.theme.badgeColor.implemented.light
            case .dark:
                return OpenWish.theme.badgeColor.implemented.dark
            @unknown default:
                return OpenWish.theme.badgeColor.implemented.light
            }
        ...
        case .pending:
            switch colorScheme {
            case .light:
                return OpenWish.theme.badgeColor.pending.light
            case .dark:
                return OpenWish.theme.badgeColor.pending.dark
            @unknown default:
                return OpenWish.theme.badgeColor.pending.light
            }
        case .inReview:
            switch colorScheme {
            case .light:
                return OpenWish.theme.badgeColor.inReview.light
            case .dark:
                return OpenWish.theme.badgeColor.inReview.dark
            @unknown default:
                return OpenWish.theme.badgeColor.inReview.light
            }
        case .planned:
            switch colorScheme {
            case .light:
                return OpenWish.theme.badgeColor.planned.light
            case .dark:
                return OpenWish.theme.badgeColor.planned.dark
            @unknown default:
                return OpenWish.theme.badgeColor.planned.light
            }
        case .inProgress:
            switch colorScheme {
            case .light:
                return OpenWish.theme.badgeColor.inProgress.light
            case .dark:
                return OpenWish.theme.badgeColor.inProgress.dark
            @unknown default:
                return OpenWish.theme.badgeColor.inProgress.light
            }
        ...
        case .completed:
            switch colorScheme {
            case .light:
                return OpenWish.theme.badgeColor.completed.light
            case .dark:
                return OpenWish.theme.badgeColor.completed.dark
            @unknown default:
                return OpenWish.theme.badgeColor.completed.light
            }
        case .rejected:
            switch colorScheme {
            case .light:
                return OpenWish.theme.badgeColor.rejected.light
            case .dark:
                return OpenWish.theme.badgeColor.rejected.dark
            @unknown default:
                return OpenWish.theme.badgeColor.rejected.light
            }
        }
    ...
    private func voteAction() {
        ...
        if isVotedByCurrentUser && OpenWish.config.allowUndoVote == false {
...
extension WishView {
    ...
    var upvoteIconImage: Image {
        switch OpenWish.config.buttons.voteButton.icon {
    ...
    var arrowColor: Color {
        if isVotedByCurrentUser {
            return OpenWish.theme.primaryColor
        }

        switch colorScheme {
        case .light:
            return OpenWish.config.buttons.voteButton.arrowColor.light
        case .dark:
            return OpenWish.config.buttons.voteButton.arrowColor.dark
        @unknown default:
            return OpenWish.config.buttons.voteButton.arrowColor.light
        }
    }
